...
class _SearchScreenState extends State<SearchScreen>
  ...
  void search() async {
    //search in user table
      ...
      var psearchResult = await HelperFunctions()
          .searchInProjectTable(searchTerm.text, context, widget.supabase) as List;
          setState(() {
                                ...
                                Padding(
                                  ...
                                  child: ListTile(
                                    leading: CircleAvatar(
                                      radius: 30,
                                      child: Image.asset(
                                        projectIcon[Random().nextInt(2)],
                                      ),
                                    ), // Iterate through rows

                                    title: Text("Project: ${searchdata.projectName} "),
                                    subtitle:Text("Team: ${searchdata.teamName}"),
                                  ),
                                ),
                                Padding(
                                  padding:const EdgeInsets.only(
                                      top: 10.0, left: 25, bottom: 2),
                                  child: Text("Date created: ${searchdata.dateCreated}"),
                                ),
                                 Padding(
                                  padding:const EdgeInsets.only(
                                      top: 10.0, left: 25, bottom: 2),
                                  child: Text("Description :${searchdata.projectDescription}"),
                                )
                              ],
                            ),
                          );
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: ListTile(
                                    ...
                                    title: Text("Bug title: ${searchdata.bugsName}"),
                                    subtitle: Text("Status: ${searchdata.bugStatus}"),
                                  ),
                                ),
                                Padding(
                                  padding:const EdgeInsets.only(
                                      top: 10.0, left: 25, bottom: 2),
                                  child: Text("Project :${searchdata.projectName} "),
                                ),
                                Padding(
                                  padding:const EdgeInsets.only(
                                      top: 10.0, left: 25, bottom: 2),
                                ...
                                Padding(
                                  padding:const EdgeInsets.only(
                                      top: 10.0, left: 25, bottom: 2),
                                  child: Text("Updated date:${searchdata.updateDate} "),
                                ),
                                Padding(
                                  padding:const EdgeInsets.only(
                                      top: 10.0, left: 25, bottom: 2),
                                  child: Text("Description: ${searchdata.bugsDescription}"),
                                )
                              ],
                            ),
                          );
